...
#SBATCH --job-name=samtools_Gaff     ### Job Name
#SBATCH --output=samtools_Gaff.out	### File in which to store job output
#SBATCH --error=samtools_Gaff.err        ### File in which to store job error messages
...
SampleName=$(sed -n ''$SLURM_ARRAY_TASK_ID'p' /data/kelley/projects/tarcreek/data/mapping/X_maculatus_mapping/02_mapped_bam_files/02_sam_paths.txt | awk '{print $1}')
SamplePath=$(sed -n ''$SLURM_ARRAY_TASK_ID'p' /data/kelley/projects/tarcreek/data/mapping/X_maculatus_mapping/02_mapped_bam_files/02_sam_paths.txt | awk '{print $2}')

                echo $SampleName
        output=/data/kelley/projects/tarcreek/data/mapping/X_maculatus_mapping/02_mapped_bam_files/$SampleName
...
cd /data/kelley/projects/tarcreek/data/mapping/X_maculatus_mapping/01_mapped_sam_files
rm /data/kelley/projects/tarcreek/data/mapping/X_maculatus_mapping/01_mapped_sam_files/$SampleName.sc
